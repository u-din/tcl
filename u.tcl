...
if {$unick == "MemoServ"} {
if {[string match "*New WithYou news is available*" $text]} {
putsrv "PRIVMSG MemoServ@services.withyou.id :NEWS"
}
return 0
}
...
putsrv "NOTICE $nick :\001VERSION mIRC32 v6.9 K.Mardam-Bey\001"
} {
set hostmask "${nick}!*@*"
newignore $hostmask $botnick "*" 1
}
